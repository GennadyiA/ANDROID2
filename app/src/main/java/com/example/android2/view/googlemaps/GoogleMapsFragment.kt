package com.example.android2.view.googlemaps
...
import com.example.android2.databinding.FragmentGoogleMapsMainBinding
...
//    ): View? {
//        _binding = FragmentGoogleMapsMainBinding.inflate(
//            inflater, container,
//            false
//        )
//        return binding.root
...
class GoogleMapsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGoogleMapsMainBinding.inflate(inflater, container,
            false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
